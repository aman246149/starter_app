...
List<RouteBase> get $appRoutes => [$appShellRoute, $authRoute, $ordersRoute];

RouteBase get $appShellRoute => StatefulShellRouteData.$route(
  factory: $AppShellRouteExtension._fromState,
  branches: [
    StatefulShellBranchData.$branch(
      observers: DashboardBranch.$observers,
      routes: [
        GoRouteData.$route(
          path: '/dashboard',
          name: 'dashboard',
    ...
    StatefulShellBranchData.$branch(
      observers: SettingsBranch.$observers,
      routes: [
        GoRouteData.$route(
          path: '/settings',
          name: 'settings',
...
RouteBase get $ordersRoute => GoRouteData.$route(
  path: '/orders',
  name: 'orders',
